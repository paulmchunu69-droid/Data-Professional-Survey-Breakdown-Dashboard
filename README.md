...
How do salaries differ across data job roles?

Which programming languages are most popular in the field?
...
Data cleaning & transformation in Power Query (renamed columns, formatted values, created calculated fields)

Built interactive visuals and measures using DAX

Designed a single-page dashboard emphasizing readability and insight discovery
...
Python is by far the most popular programming language among professionals.

The average respondent rates work-life balance higher (5.7/10) than salary satisfaction (4.2/10).

Nearly half of respondents say breaking into data is “neither easy nor difficult,” but many still find it challenging.
